...
public class FalloutGmailControl {
    public  void reqViewmodel(String mFalloutGmailUrl, RequestParams params, String tokeninHead, final ILoginDataPass loginInterface){
        AsyncHttpClient client= new AsyncHttpClient();
            client.addHeader("x-token",tokeninHead);

        client.post(mFalloutGmailUrl, params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                } Log.i("gmailfallout", "onSuccess: ");

            }

            @Override
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                Log.i("gmailfallout", "onfail: ");
